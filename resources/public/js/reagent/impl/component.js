...
if((i < len)){
var k = (ks[i]);
var G__10003 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__10004 = (i + (1));
m = G__10003;
i = G__10004;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__10006 = c;
var G__10006__$1 = (((G__10006 == null))?null:G__10006.prototype);
if((G__10006__$1 == null)){
return null;
} else {
return (G__10006__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__10008 = c;
var G__10008__$1 = (((G__10008 == null))?null:G__10008.prototype);
if((G__10008__$1 == null)){
return null;
} else {
return (G__10008__$1["render"]);
}
})() == null)));
});
...
var _STAR_current_component_STAR_10015 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10015;
}});
...
var G__10016 = key;
var G__10016__$1 = (((G__10016 instanceof cljs.core.Keyword))?G__10016.fqn:null);
switch (G__10016__$1) {
...
return ((function (G__10016,G__10016__$1){
...
var or__8009__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__8009__auto__){
...
if((f == null)){
var or__8009__auto____$1 = noargv;
if(or__8009__auto____$1){
return or__8009__auto____$1;
} else {
try{return cljs.core.not_EQ_.call(null,old_argv,new_argv);
}catch (e10020){var e = e10020;
if(cljs.core.truth_(reagent.debug.has_console)){
(cljs.core.truth_(reagent.debug.tracking)?reagent.debug.track_console:console).warn([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Warning: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1("Exception thrown while comparing argv's in shouldComponentUpdate: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)].join(''));
} else {
}
...
var c = this;
var G__10021_10023 = (c["cljsRatom"]);
if((G__10021_10023 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__10021_10023);
}
...
if(cljs.core.truth_((function (){var and__7997__auto__ = wrap;
if(cljs.core.truth_(and__7997__auto__)){
return f;
} else {
...
if(((1) === cljs.core.count.call(null,renders_10025))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_10026)){
} else {
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Expected something callable, not "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_10026))].join('')),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(clojure.core/ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__8009__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8009__auto__)){
return or__8009__auto__;
} else {
...
var render_fun__$1 = (function (){var or__8009__auto__ = render_fun;
if(cljs.core.truth_(or__8009__auto__)){
return or__8009__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__8009__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8009__auto__)){
return or__8009__auto__;
} else {
...
var name__$1 = (function (){var G__10024 = name;
switch (G__10024) {
case "":
...
var G__10028 = o;
(G__10028[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__10029 = fiber;
var G__10029__$1 = (((G__10029 == null))?null:(G__10029["type"]));
if((G__10029__$1 == null)){
return null;
} else {
return (G__10029__$1["displayName"]);
}
})();
var parent = (function (){var G__10030 = fiber;
if((G__10030 == null)){
return null;
} else {
return (G__10030["return"]);
}
})();
var path = (function (){var G__10031 = parent;
var G__10031__$1 = (((G__10031 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__10031));
if((G__10031__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10031__$1),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" > ")].join('');
}
})();
...
var temp__4655__auto__ = (function (){var or__8009__auto__ = (function (){var G__10033 = c;
if((G__10033 == null)){
return null;
} else {
return (G__10033["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__8009__auto__)){
return or__8009__auto__;
...
return G__10034._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__8009__auto__ = (function (){var G__10036 = c;
if((G__10036 == null)){
return null;
} else {
...
var or__8009__auto____$1 = (function (){var G__10038 = c;
if((G__10038 == null)){
return null;
} else {
return G__10038._reactInternalInstance;
}
})();
...
var elem = (function (){var or__8009__auto__ = (function (){var G__10040 = instance;
if((G__10040 == null)){
return null;
} else {
return (G__10040["_currentElement"]);
}
})();
if(cljs.core.truth_(or__8009__auto__)){
return or__8009__auto__;
} else {
var G__10041 = instance;
if((G__10041 == null)){
return null;
} else {
return G__10041._currentElement;
}
}
})();
var name = (function (){var G__10042 = elem;
var G__10042__$1 = (((G__10042 == null))?null:(G__10042["type"]));
if((G__10042__$1 == null)){
return null;
} else {
return (G__10042__$1["displayName"]);
}
})();
var owner = (function (){var or__8009__auto__ = (function (){var G__10044 = elem;
if((G__10044 == null)){
return null;
} else {
return (G__10044["_owner"]);
}
})();
if(cljs.core.truth_(or__8009__auto__)){
return or__8009__auto__;
...
return G__10045._owner;
}
}
})();
var path = (function (){var G__10046 = owner;
var G__10046__$1 = (((G__10046 == null))?null:reagent.impl.component.component_path.call(null,G__10046));
if((G__10046__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10046__$1),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" > ")].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var n = (function (){var or__8009__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__8009__auto__)){
return or__8009__auto__;
} else {
var G__10047 = c;
var G__10047__$1 = (((G__10047 == null))?null:G__10047.constructor);
if((G__10047__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__10047__$1);
}
}
})();
