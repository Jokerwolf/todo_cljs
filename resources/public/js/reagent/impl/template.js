...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8634__auto__,writer__8635__auto__,opt__8636__auto__){
return cljs.core._write.call(null,writer__8635__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__10050 = o;
(G__10050[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__10051__delegate = function (args){
...
while (G__10052__i < G__10052__a.length) {G__10052__a[G__10052__i] = arguments[G__10052__i + 0]; ++G__10052__i;}
  args = new cljs.core.IndexedSeq(G__10052__a,0,null);
} 
...
var G__10054 = o;
(G__10054[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__10059 = props;
var G__10059__$1 = (((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null)))?cljs.core.assoc.call(null,G__10059,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10059);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10059__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((reagent.impl.template.named_QMARK_.call(null,old_class))?cljs.core.name.call(null,old_class):old_class))].join('');
}
})());
} else {
return G__10059__$1;
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10060){
...
var props = map__10061__$1;
var class$ = cljs.core.get.call(null,map__10061__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__10061,map__10061__$1,props,class$){
return (function (c){
...
});})(map__10061,map__10061__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10063){
...
var on_write = cljs.core.get.call(null,map__10064__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__10064,map__10064__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__10064,map__10064__$1,on_write))
);
} else {
...
if(cljs.core.truth_((function (){var and__7997__auto__ = !((jsprops == null));
if(and__7997__auto__){
var and__7997__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__7997__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__7997__auto____$1;
}
} else {
...
var G__10067 = jsprops;
(G__10067["defaultValue"] = value);

(G__10067["onChange"] = ((function (G__10067,v,value,on_change){
return (function (p1__10066_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10066_SHARP_);
});})(G__10067,v,value,on_change))
);
...
var vec__10070 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10070,(0),null);
var id = cljs.core.nth.call(null,vec__10070,(1),null);
var class$ = cljs.core.nth.call(null,vec__10070,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___10074 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___10074 == null)){
} else {
var key_10075 = temp__4661__auto___10074;
(jsprops["key"] = key_10075);
}
...
var temp__4661__auto___10076 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___10076 == null)){
} else {
var key_10077 = temp__4661__auto___10076;
reagent.impl.template.oset.call(null,jsprops,"key",key_10077);
}
...
var G__10078 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__10078["name"] = c);
...
var len__9173__auto___10083 = arguments.length;
var i__9174__auto___10084 = (0);
while(true){
if((i__9174__auto___10084 < len__9173__auto___10083)){
args__9180__auto__.push((arguments[i__9174__auto___10084]));

var G__10085 = (i__9174__auto___10084 + (1));
i__9174__auto___10084 = G__10085;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9181__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10081){
var G__10082 = cljs.core.first.call(null,seq10081);
var seq10081__$1 = cljs.core.next.call(null,seq10081);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__10082,seq10081__$1);
});
...
break;
default:
var G__10088 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10088;
continue;
...
var n__8949__auto___10090 = a.length;
var i_10091 = (0);
while(true){
if((i_10091 < n__8949__auto___10090)){
(a[i_10091] = reagent.impl.template.as_element.call(null,(a[i_10091])));
...
var a = cljs.core.into_array.call(null,s);
var n__8949__auto___10093 = a.length;
var i_10094 = (0);
while(true){
if((i_10094 < n__8949__auto___10093)){
var val_10095 = (a[i_10094]);
if((cljs.core.vector_QMARK_.call(null,val_10095)) && ((reagent.impl.template.key_from_vec.call(null,val_10095) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10094] = reagent.impl.template.as_element.call(null,val_10095));
...
var ctx = ({});
var vec__10097 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10097,(0),null);
var derefed = cljs.core.nth.call(null,vec__10097,(1),null);
...
var G__10100 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10100) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__10100){
